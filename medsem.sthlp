...
{phang}{stata . qui sem(Attractive -> face sexy) (Appearance -> body appear attract) (Muscle -> muscle strength endur) (Weight -> lweight calories cweight) (Appearance <- Attractive age) (Muscle <- Appearance Attractive age) (Weight <- Appearance Attractive age)
}{p_end}
